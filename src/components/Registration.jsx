export default function Registration({phone, setphone, handleOpenNumberAuth}) {
    const social = [
        {
            name: "Facebook",
    ...
    return (
        <div className="p-4 mb-5">
            ...
            <div className="d-flex flex-column justify-content-center align-items-center mt-4">
                ...
                <button className="btn btn-primary p-2 col-11 my-1 mx-auto" onClick={handleOpenNumberAuth}>Continue</button>
            </div>
