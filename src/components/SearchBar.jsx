export default function SearchBar({handleOpenFilter}) {
    return (
        <div className="search-container position-relative p-2 mt-2 mx-3">
            <button type="text" id="search-input" className="search-input form-control rounded-5 ps-5 py-4" />
            ...
            <button className="search-filter-button position-absolute rounded-4 py-1" onClick={handleOpenFilter}>
