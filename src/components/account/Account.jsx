    ...
    return (
        <>
            ...
            <main className="account-main d-flex flex-column p-2">
                ...
                <button className="payment-contayner border-0 border-bottom border-secondary py-4 text-start position-relative">
                ...
                <button className="notify-contayner border-0 border-bottom border-secondary py-4 text-start position-relative">
                    <span className="d-block fs-5 mb-2">Notificações</span>
                    <span className="text-secondary">Como entramos em contato com você</span>
                    <CaretRight size={30} className="position-absolute end-0 top-50 translate-middle" />
                </button>
                <button className="login-contayner border-0 border-bottom border-secondary py-4 text-start position-relative" onClick={() => navigate("/profile/account/login-and-security")}>
                    <span className="d-block fs-5 mb-2">Login e segurança</span>
                    <span className="text-secondary">Senha e histórico de login</span>
                    <CaretRight size={30} className="position-absolute end-0 top-50 translate-middle"/>
                </button>
                <button className="preferer-contayner border-0 border-bottom border-secondary py-4 text-start position-relative">
                ...
                <button className="privac-contayner border-0 border-bottom border-secondary py-4 text-start position-relative">
                ...
                <button className="workTravel-contayner border-0 border-bottom border-secondary py-4 text-start position-relative">
                ...
                <button className="tools-contayner border-0 py-4 text-start position-relative">
