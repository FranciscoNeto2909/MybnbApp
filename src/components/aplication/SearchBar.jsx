    ...
    return (
        <div className="search-container position-relative p-2 mt-2 mx-3">
            ...
            <div className="search-filter-container position-absolute px-3 p-2">
                <button className="search-filter-btn py-1 rounded-5 bg-transparent" onClick={() => dispatch(hideNav())}><img src="https://icons-for-free.com/iconfiles/png/512/filter-131979013401653166.png" className="search-button-img" /> </button>
            </div>
